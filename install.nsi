...
section "install"
    setOutPath $INSTDIR
    File /nonfatal /a /r "dist\Camera Controller\" #note back slash at the end
    ...
    createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "$INSTDIR\Camera Controller.exe" "" "$INSTDIR\favicon.ico"
